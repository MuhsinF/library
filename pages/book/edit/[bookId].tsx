...
const ModifyBookMutation = gql`
  mutation modifyBook($bookId: ID!, $title: String!, $author: String!, $date: String!, $collection: Collection, $rating: Int) {
    modifyBook(
      bookId: $bookId
      title: $title
      author: $author
...
export default function Edit () {
 ...
 const onSubmit = data => {
  const {bookId, title, author, date, collection, rating} = data
  const variables = {bookId, title, author, date, collection: collection.value, rating}
